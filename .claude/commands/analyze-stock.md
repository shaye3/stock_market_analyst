...
Following the instructions in `/Users/shayeyal/PycharmProjects/Stock_Analysis_System/agents/claude_code_agents/market_intelligence.md`, analyze:
...
Following the instructions in `/Users/shayeyal/PycharmProjects/Stock_Analysis_System/agents/claude_code_agents/macro_economy.md`, analyze:
...
Following the instructions in `/Users/shayeyal/PycharmProjects/Stock_Analysis_System/agents/claude_code_agents/fundamental_analysis.md`, analyze:
...
Following the instructions in `/Users/shayeyal/PycharmProjects/Stock_Analysis_System/agents/claude_code_agents/technical_analysis.md`, analyze:
...
Following the instructions in `/Users/shayeyal/PycharmProjects/Stock_Analysis_System/agents/claude_code_agents/analyst_sentiment.md`, analyze:
- Analyst consensus from `FINANCIALS_DATA.analyst_consensus`
...
Following the instructions in `/Users/shayeyal/PycharmProjects/Stock_Analysis_System/agents/claude_code_agents/risk_assessment.md`, analyze:
...
Once all 6 agent reports are complete, act as the **Chief Investment Analyst** following `/Users/shayeyal/PycharmProjects/Stock_Analysis_System/agents/claude_code_agents/chief_analyst.md`.
